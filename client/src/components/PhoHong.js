...
//Function for Pho Hong page
function PhoHong(props) {
  //Sets the center of the map
  const [center, setCenter] = useState([44.4888, -73.2071]);
  //Sets the marker of the map
  const [marker, setMarker] = useState([44.4888, -73.2071]);
...
//Exports Pho Hong function to be used in other components
export default PhoHong;
